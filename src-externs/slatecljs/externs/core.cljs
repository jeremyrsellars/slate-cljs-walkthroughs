...
(defn generated-by-header
  [js-var-name]
  (println "// Generated via https://github.com/jeremyrsellars/slate-cljs-walkthroughs#closure-externs")
  (println "// from NPM")
  (println)
  (println "// Reference ns as" js-var-name)
  (println "/**********************************************************************")
  (println " * Extern for" js-var-name)
  (println " * Generated by https://github.com/jeremyrsellars/slate-cljs-walkthroughs#closure-externs")
  (println " **********************************************************************/"))
...
(defn externs-str
  [js-var-name externs]
  (with-out-str
    (generated-by-header js-var-name)
